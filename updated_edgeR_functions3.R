...
#' extracts input from the pipeline
#'
...
#' write output directory for the part of the anlysis to run
#'
#' @param pipeline_input 
#'
#' @return output directory for the analysis to be run
#' @export
#'
#' @examples
...
#' preprocessing the data after reading the arguments from the arguments file
#'
#' @param arguments_file 
#'
...
#' @param ... 
#'
#' @return volcanto plot
#' @export
#'
#' @examples
volcanoplot_edge_R <- function (res, lfcthresh=2, sigthresh=0.05, main="Volcano Plot for 3_vs_0", legendpos="bottomright", labelsig=TRUE, textcx=1, ...) {
  Gene=rownames(res)
...
pipeline_inputs<-extract_pipeline_input_from_input_file(arguments_file)
data_preprocessing(arguments_file)
fitting_data(arguments_file)
